        ...
        if (posicao.equals("goleiro")) {
            if(goleiro >= 2) {
                ...
                if (idade >= 15 && idade <= 17)  {
                    FranciscoCleiton_Testes.jogjII[pos].setJogador(nome);
                    FranciscoCleiton_Testes.jogjII[pos].setPosicao(posicao);
                    FranciscoCleiton_Testes.jogjII[pos].setIdadejunior(idade);
                    goleiro++;
                    quantjogadores++;
